...
*
* @author joker 
* @date 创建时间：2018年6月7日 下午12:37:38
* 
*/
...
public class RSAUtils
{
	...
	public static String encryptByPublic(String encryptStr, byte[] publicKeyBytes) throws UnsupportedEncodingException
	{
		return encryptByPublic(encryptStr, new String(publicKeyBytes, "utf-8"));
	}
