...
//	@Update("update dlxy_article_picture set picture_status =#{status} where article_id=#{articleId}")
//	void updatePicStatusByArticleId(@Param("articleId") Long articleId, @Param("status") int status);
