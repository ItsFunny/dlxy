...
//	Collection<Map<String, Object>>findByPage(int pageSize,int pageNum,Map<String, Object>params) throws SQLException;
	...
	Long countRecords(Map<String, Object>params) throws SQLException;
	
	/*
	 * 查询用户的操作记录
	 */
	Collection<UserRecordDTO>findRecordByPage(int pageSize,int pageNum,Map<String, Object>params) throws SQLException;
