    ...
    public static class ArticleNormalResultSetHandler implements ResultSetHandler<List<ArticleDTO>>
    {
        ...
        public List<ArticleDTO> handle(ResultSet rs) throws SQLException
        {
            ...
            while (rs.next())
            {
                ...
                articleDTO.setTitleName(rs.getString(1));
                articleDTO.setArticleId(rs.getLong(2));
                articleDTO.setTitleId(rs.getInt(3));
                articleDTO.setArticleName(rs.getString(4));
                articleDTO.setArticleAuthor(rs.getString(5));
                articleDTO.setArticleType(rs.getInt(6));
                articleDTO.setCreateDate((Date) rs.getObject(7));
                articleDTO.setUpdateDate((Date) rs.getObject(8));
                articleDTO.setArticleStatus(rs.getInt(9));
                articleDTO.setRealname(rs.getString(10));
                articleDTO.setUserId(rs.getLong(11));
                articleDTO.setDeleteDate((Date) rs.getObject(12));
                if (!StringUtils.isEmpty(rs.getString(13)))
                {
                    articleDTO.setTitleName(rs.getString(13));
                }
    ...
    public static class ArticleTypeResultSetHandler implements ResultSetHandler<List<ArticleDTO>>
    {
        ...
        public List<ArticleDTO> handle(ResultSet rs) throws SQLException
        {
            ...
            while (rs.next())
            {
                ...
                articleDTO.setPictureUrl(rs.getString(14));
                articleDTOs.add(articleDTO);
            }
