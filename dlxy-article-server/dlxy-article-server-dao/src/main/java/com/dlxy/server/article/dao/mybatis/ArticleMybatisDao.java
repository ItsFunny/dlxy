...
public interface ArticleMybatisDao
{
	...
	@Select("select article_id,title_id,article_name,article_author,article_content,article_type,article_status,create_date,update_date from dlxy_article where article_id =#{articleId}")
